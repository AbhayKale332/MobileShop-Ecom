...
if (!isset($_SESSION['admin_logged_in'])){
    ...
    $stmt = $conn->prepare("SELECT * FROM repairs ORDER BY repair_ID DESC");
    $stmt->execute();
            ...
            <div class="table-responsive">
                <table class="table table-striped table-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                        <td><?php echo $order['repair_ID']; ?></td>
                        <td><?php echo $order['user_name']; ?></td>
                        <td><?php echo $order['user_phone']; ?></td>
                        <td><?php echo $order['phone_brand']; ?></td>
                        <td><?php echo $order['phone_issue']; ?></td>
                        <td><?php echo $order['repair_date']; ?></td>
                        <td><?php echo $order['repair_cost']; ?></td>
                        <td><a class="edit-btn" href="edit_repair.php?repair_id=<?php echo $order['repair_ID'] ?>">Edit Status</a></td>
                        </tr>
                        <?php } ?>
                    </tbody>
                </table>
