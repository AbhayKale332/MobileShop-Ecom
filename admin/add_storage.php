...
<body>
    ...
    <aside id="sidebar">
        ...
        <div class="main p-3">
            ...
            <div class="edit-form">
                <form id="create-form" method="POST" action="update_storage.php">
                ...
                <input type="text" value="<?php echo $pinfo['product_color']; ?>" id="color" name="color" required>
                ...
                <input type="text" value="<?php echo $pinfo['product_image']; ?>" id="image1" name="image1" hidden/>
                <input type="text" value="<?php echo $pinfo['product_image2']; ?>" id="image2" name="image2" hidden/>
                <input type="text" value="<?php echo $pinfo['product_image3']; ?>" id="image3" name="image3" hidden/>
                <input type="text" value="<?php echo $pinfo['product_image4']; ?>" id="image4" name="image4" hidden/>
                <input type="text" value="<?php echo $pinfo['product_image5']; ?>" id="image5" name="image5" hidden/>
            ...
            <label for="color">ROM SIZE :</label>
            <input type="text" id="rom_size" name="rom_size"  >
            <label for="color">RAM SIZE :</label>
